				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('shipinjiaocheng','购买')" @click="onAcrossTap('shipingoumai')" type="button" class="layui-btn">
								购买
							</button>
		...
		<script>
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`shipinjiaocheng`);
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
																									vue.title = vue.detail.shipinmingcheng;
																														// 轮播图片
					vue.swiperList = vue.detail.shipinfengmian ? vue.detail.shipinfengmian.split(",") : [];
																																																																																															var swiperItemHtml = '';
