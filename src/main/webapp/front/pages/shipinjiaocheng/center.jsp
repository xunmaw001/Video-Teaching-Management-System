				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<select name="shipinfenlei" id="shipinfenlei">
									...
									<option v-for="(item,index) in shipinfenlei" v-bind:key="index" :value="item">{{item}}</option>
                                                                                                ...
                                                                                                <div class="layui-form-item">
							<div class="layui-input-block">
								<img id="shipinfengmianImg" style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;" src="../../img/avator.png">
								<input type="hidden" id="shipinfengmian" name="shipinfengmian" />
							</div>
						</div>
						<div class="layui-form-item">
							<div class="layui-input-block">
							...
							<div class="layui-input-block">
								<input type="text" name="shipinjieshao" id="shipinjieshao" placeholder="视频介绍" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">购买价格</label>
							<div class="layui-input-block">
								<input type="text" name="goumaijiage" id="goumaijiage" placeholder="购买价格" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload'], function() {
				...
				http.request(`${table}/session`, 'get', {}, function(data) {
					...
					form.val("myForm", data.data);
																																													// 图片赋值
					jquery("#shipinfengmianImg").attr("src", data.data.shipinfengmian);
																																																																																														});
