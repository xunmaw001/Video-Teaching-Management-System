				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="shipinbianhao" id="shipinbianhao" placeholder="视频编号" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<select name="yonghupingfen" id="yonghupingfen">
									<option value="">请选择</option>
									<option v-for="(item,index) in yonghupingfen" v-bind:key="index" :value="item">{{item}}</option>
								</select>
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="pingjianeirong" id="pingjianeirong" placeholder="评价内容" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">评价日期</label>
							<div class="layui-input-block">
								<input type="text" name="pingjiariqi" id="pingjiariqi" placeholder="评价日期" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                																																...
                																																vue.yonghupingfen = '1,2,3,4,5'.split(',')
