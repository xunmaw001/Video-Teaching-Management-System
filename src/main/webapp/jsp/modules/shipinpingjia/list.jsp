		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">视频评价管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">视频评价列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">视频评价列表</h3>							
												...
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																																						...
																																						<th onclick="sort('dingdanbianhao')">订单编号<i id="dingdanbianhaoIcon" class="fa fa-sort"></i></th>
																																																			...
																																																			<th onclick="sort('yonghupingfen')">用户评分<i id="yonghupingfenIcon" class="fa fa-sort"></i></th>
	...
	<script>
			...
			row.appendChild(checkbox)
							...
							var dingdanbianhaoCell  = document.createElement('td');
									...
									row.appendChild(shipinmingchengCell);
				            				var yonghupingfenCell  = document.createElement('td');

												  yonghupingfenCell.innerHTML = item.yonghupingfen; 
                
									row.appendChild(yonghupingfenCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("shipinpingjia/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"shipinpingjia");
