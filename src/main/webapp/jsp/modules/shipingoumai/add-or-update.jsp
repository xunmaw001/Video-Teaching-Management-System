								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										...
										<input id="shipinmingcheng" name="shipinmingcheng" class="form-control" placeholder="视频名称">
											...
											<div class="form-group col-md-6">
										<label>视频分类</label>
										<input id="shipinfenlei" name="shipinfenlei" class="form-control" placeholder="视频分类">
									</div>
											<div class="form-group col-md-6">
										<label>购买价格</label>
										...
										<div id="goumairiqiDate" class="input-append date form_datetime">
											<input id="goumairiqi-input" name="goumairiqi" size="15" type="text" readonly>
	...
	<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/resources/js/datetimepicker/bootstrap-datetimepicker.min.js"></script>
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("shipingoumai/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("shipingoumai/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			$("#updateId").val(ruleForm.id);	
												$("#dingdanbianhao").val(ruleForm.dingdanbianhao);	
																...
																$("#shipinfenlei").val(ruleForm.shipinfenlei);	
					...
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
												...
												if(res.data != null && res.data != '' && res.data.shipinfenlei != null && res.data.shipinfenlei != ''){
															...
															$("#shipinfenlei").val(res.data.shipinfenlei);
													}
